...
(function($){		
	$.fn.jqte = function(options){
		...
		return this.each(function(){
			...
			jQTE.html('<div class="' + vars.css + "_toolbar" + '" role="toolbar" unselectable></div><div class="' + vars.css + '_linkform" style="display:none" role="dialog"></div><div class="' + vars.css + "_editor" + '" id ="' + vars.css + '_' + vars.id + '"></div>');
